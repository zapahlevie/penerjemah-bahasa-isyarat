...
public class fist extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(R.id.fist);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        for (int i = 0; i < facesArray.length; i++){
            ...
            Core.putText(mRgba, "A Sign", facesArray[i].tl(), 1, 2, new Scalar(255, 0, 0, 255), 3);
        }
